...
<Dropdown id="navLoginManager" class="login-menu">
    ...
    <DropdownMenu>                    
        {#if !$userInfoStore.isLogin}
            <DropdownItem>
                <button on:click="{open_login_modal}" class="btn btn-dark">
                    התחבר
                </button>
            </DropdownItem>
        {:else}
