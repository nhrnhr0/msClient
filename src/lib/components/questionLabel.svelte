<script>
	...
	export let AllClassName = ''
</script>

<svg {...$$props} class="{AllClassName}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 50 50" enable-background="new 0 0 50 50;" xml:space="preserve">
<g class="{AllClassName}">
	<g class="{AllClassName}">
		<path class="{AllClassName}" d="M45,0H5C2.25,0,0,2.25,0,5v40c0,2.75,2.25,5,5,5h40c2.75,0,5-2.25,5-5V5C50,2.25,47.75,0,45,0z M46,45
			c0,0.542-0.458,1-1,1H5c-0.542,0-1-0.458-1-1V5c0-0.542,0.458-1,1-1h40c0.542,0,1,0.458,1,1V45z"/>
		<path class="{AllClassName}" d="M24.733,34.318c-0.936,0-1.73,0.322-2.375,0.947c-0.645,0.627-0.968,1.414-0.968,2.338c0,1.035,0.334,1.85,1,2.429
		...
		<path class="{AllClassName}" d="M30.896,8.772c-1.631-0.791-3.51-1.18-5.629-1.18c-2.295,0-4.294,0.473-6.005,1.401c-1.718,0.943-3.026,2.126-3.919,3.562
