...
>
  ...
  <div class="modal_content" style="z-index: {modal_zIndex + 10};">
          ...
          {#each prods as img}
            <div class="category-item" data-category-prod-id={img.id}>
              <div class="image-and-title-wraper">
                <div
                  class="category-item-img-wraper"
                  on:click={open_product(img)}
                >
                  <img
                    class="product-image"
                    width="250px"
                    height="250px"
                    src="{CLOUDINARY_URL}f_auto,w_auto/{img.cimage}"
                    alt={img.description}
                  />
              ...
              <div data-img={JSON.stringify(img)} class="like-btn-wraper">
                ...
                <div class="like-btn like-btn-small">
                  <button
                    class:gold={$cartStore[img.id] != undefined}
                    class="action-btn add-to-cart-btn"
                    on:click={likeBtnClicked(img)}
                  >
    ...
    <div class="modal-footer">
      <img
        class="header-logo header-logo-r"
        alt="M.S. Global"
      ...
      <img
        class="header-logo header-logo-l"
        alt="M.S. Global"
        src="https://res.cloudinary.com/ms-global/image/upload/w_auto,f_auto/v1634457672/msAssets/favicon_rza3n9"
      />
    </div>
