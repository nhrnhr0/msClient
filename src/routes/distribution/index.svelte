...
<div class="bg-wraper">
  <main>
    <form bind:this={mform} autocomplete="off" class="distribution-form bg-color-primary" class:submited>
      <div class="vip-text">
        <div>כל הלקוחות שלנו הם V.I.P אבל יש כאלה שמרוויחים <span class="mark-strong">יותר</span>...</div>

        <div>
          <span class="mark-strong"> רוצים להרוויח גם? </span>
        </div>

        <div>הצטרפו למועדון הלקוחות שלנו ותתחילו להרוויח <span class="mark-strong">יותר</span> על כל הזמנה!</div>
      </div>
      <!--
                    טופס
                    שם העסק
      ...
      <div class="form-fields">
        <fieldset>
          ...
          <AutoComplete
            ...
            createText="לא נמצאו תוצאות, בחר ב'אחר'"
            create="false"
            ...
            labelFieldName="name"
            valueFieldName="name"
            bind:value={business_type_results}
          >
            <!--
                                ...
                                -->
            <div class="tag-wraper" slot="tag" let:label let:item let:unselectItem>
            ...
            <div class="business-types-groups-btns">
              ...
              {#each business_types_groups as business_types_group}
                <button
                  on:click={(e) => {
                    e.preventDefault();
                    add_bulk_intrests(business_types_group.intrests, e);
          ...
          <AutoComplete
            ...
            id="intrested"
            items={intrests}
            createText="לא נמצאו תוצאות"
            create="false"
            placeholder="מוצרים מעניינים"
            className="autocomplete-cls"
            delay="200"
            localFiltering={false}
            labelFieldName="name"
            valueFieldName="name"
            bind:selectedItem={instrests_results2}
            bind:value={instrests_results}
          >
            <!--
                                    <div slot="loading" let:loadingText={loadingText}>
                                        <Spinner
