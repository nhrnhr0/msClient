...
function submit_form(e) {
  ...
  save_lead_to_server(formDataObj)
    .then((res) => {
...
<div class="bg-wraper">
  ...
  <main>
    <form class="distribution-form">
      ...
      <!-- שם איש קשר -->
      <div class="form-group">
        <label for="bussiness_contact_name"
          >שם איש קשר
      ...
      <button class="sub-btn" on:click|preventDefault={submit_form} type="submit"> רוצה להצטרף לדיוור בוואצאפ </button>
    </form>
  </main>
</div>
